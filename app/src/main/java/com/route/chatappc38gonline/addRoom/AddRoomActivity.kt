...
import com.route.chatappc38gonline.addRoom.ui.theme.ChatAppC38GOnlineTheme
import com.route.chatappc38gonline.login.ChatAuthTextField
...
fun AddRoomCard(
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(
            ...
            contentColor = colorResource(id = R.color.colorBlack2)
        )
    ) {
        Text(
            ...
            style = TextStyle(
                colorResource(id = R.color.colorBlack2),
                fontSize = 20.sp,
        ...
        ChatAuthTextField(
            ...
            label = stringResource(id = R.string.room_desc),
